/*! Chat Widget v1.0.3 | MIT License */
class ApiPickerChatAi{static init(t){let e=new ApiPickerChatAi(t);return(async()=>{await e.setupEvents(),await e.checkAuth(),e.render()})(),e}constructor(t){this.config=t,this.isOpen=!1,this.user=null,this.apiUrl=t?.apiUrl||"https://api.apipicker.com"}log(...t){this.config?.debug&&console.log("ApiPickerAi",t)}render(){this.container=document.createElement("div"),this.container.id="chat-container",this.container.innerHTML=`
