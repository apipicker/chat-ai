/*! Chat Widget v1.0.2 | MIT License */
class ApiPickerChatAi{static init(t){let e=new ApiPickerChatAi(t);return(async()=>{await e.setupEvents(),await e.checkAuth(),e.render()})(),e}constructor(t){this.config=t,this.isOpen=!1,this.user=null,this.apiUrl=t?.apiUrl||"http://130.195.222.180:7007"}log(...t){this.config?.debug&&console.log("ApiPickerAi",t)}render(){this.container=document.createElement("div"),this.container.id="chat-container",this.container.innerHTML=`
